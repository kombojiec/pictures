...
var calc = function calc(sizeSelector, materialSelector, optionsSelector, promoSelector, resultSelector) {
  var size = document.querySelector(sizeSelector);
  var material = document.querySelector(materialSelector);
  ...
  function calculateSum() {
    ...
    if (!size.value || !material.value) {
      ...
      result.textContent = new Intl.NumberFormat('ru-RU', {
        style: 'currency',
        currency: 'RUB'
      }).format(Math.round(total * 0.7));
    } else {
      result.textContent = new Intl.NumberFormat('ru-RU', {
        style: 'currency',
        currency: 'RUB'
...
var collapse = function collapse(title) {
...
/* harmony import */ var _utiles_api__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../utiles/api */ "./src/js/utiles/api.js");
...
var forms = function forms() {
  ...
  forms.forEach(function (form) {
    ...
    form.addEventListener('submit', function (event) {
      ...
      var statusMessageText = document.createElement('div');
...
/* harmony default export */ __webpack_exports__["default"] = (forms); // https://pictures-546d3-default-rtdb.firebaseio.com/orders.json
...
var pictureSize = function pictureSize() {
  var pictures = document.querySelectorAll('.sizes-block');
...
var slider = function slider(slideSelector, direct, prevButtonSelector, nextButtonSelector) {
  var moveStep = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 1;
...
/* harmony import */ var _utiles_api__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utiles/api */ "./src/js/utiles/api.js");





var styles = function styles(buttonSelector) {
  var button = document.querySelector(buttonSelector);

  function getTemplate(templateselector) {
    return document.querySelector(templateselector).content.querySelector('.styles-2').cloneNode(true);
  }

  function createCard(name, src, link) {
    var card = getTemplate('.style__template');
  ...
  function renderCard(parentSelector, _ref) {
    var name = _ref.name,
        src = _ref.src,
        link = _ref.link;
  ...
  var data = Object(_utiles_api__WEBPACK_IMPORTED_MODULE_3__["getData"])('https://pictures-546d3-default-rtdb.firebaseio.com/cards.json').then(function (data) {
    button.addEventListener('click', function () {
