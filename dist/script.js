...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_styles__WEBPACK_IMPORTED_MODULE_5__["default"])('.button-styles', '.styles-2'); // https://pictures-546d3-default-rtdb.firebaseio.com/orders
...
var forms = function forms() {
  ...
  forms.forEach(function (form) {
    ...
    form.addEventListener('submit', function (event) {
      ...
      var data = {}; // inputs.forEach(input => {
      //   data[input.name] = input.value;
      // })

      data = new FormData(form); // console.log(JSON.stringify(data);

      postData(apiPath, data).then(function (res) {
...
var styles = function styles(buttonSelector, styleselector) {
